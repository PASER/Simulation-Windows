...
public:
    ...
    int MYgetWlanInterfaceIndexByAddress(Uint128 add);
    int MYgetNumWlanInterfaces();
    int MYgetNumInterfaces();
    void MY_omnet_chg_rte(const Uint128 &dst, const Uint128 &gtwy,
...
protected:
    ...
    ;
    virtual void setRefreshRoute(const Uint128 &destination,
            const Uint128 & nextHop, bool isReverse) {
    }
    ;
     ...
     */
    void sendUDPToIp(cPacket *msg, int srcPort, const Uint128& destAddr,
