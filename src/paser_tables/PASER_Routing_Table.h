...
public:
    ...
    PASER_Routing_Entry *insert(struct in_addr dest_addr,
            ...
            PASER_Timer_Message * validtimer, u_int32_t seqnum, u_int8_t hopcnt,
            u_int8_t is_gw, std::list<address_range> AddL, u_int8_t *Cert);
    ...
    PASER_Routing_Entry *update(PASER_Routing_Entry *entry,
            ...
            u_int32_t seqnum, u_int8_t hopcnt, u_int8_t is_gw,
    ...
    void updateRoutingTableAndSetTableTimeout(std::list<address_range> addList,
            ...
            struct in_addr nextHop, u_int8_t metric, int ifIndex,
            struct timeval now, u_int8_t gFlag, bool trusted);
